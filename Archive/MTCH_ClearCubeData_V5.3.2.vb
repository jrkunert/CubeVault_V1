...
Imports OneStream.Shared.Wcf
	...
	'=====================================================================
	' Business Rule: MTCH_ClearCubeData
	'
	' Version History
	'
	' 5.4  2026-07-19
...
'=====================================================================
        ...
        '=========================================================
			...
			'Private Shared Sub LogEnvironment( _
			...
			'Private Shared Sub LogCurrentPOV( _
			'		ByVal si As SessionInfo, _
			'		ByVal api As FinanceRulesApi)
			'
			...
			Private Shared Sub ExecuteHealthCheck( _
				...
				Try
					...
					Log(si, "HealthCheck logging test.")

					LogField(si, "Logging Framework", "PASS")
					passCount += 1

				Catch

					LogField(si, "Logging Framework", "FAIL")
					failCount += 1
				...
				Try
					...
					Dim accountDimPk As DimPk =
						api.Dimensions.GetDim("Account").DimPk

					LogField(si, "Metadata Access", "PASS")
					passCount += 1
				...
				LogField(si, "Passed", passCount.ToString())
				LogField(si, "Failed", failCount.ToString())
				LogField(si, "Elapsed", sw.Elapsed.ToString())
