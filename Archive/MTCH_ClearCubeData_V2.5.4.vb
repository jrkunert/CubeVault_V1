...
Namespace OneStream.BusinessRule.Finance.MTCH_ClearCubeData
	...
	Public Class MainClass
		...
		Private Const BR_VERSION As String = "2.5.3"
				...
				If Not parser.EndOfData Then
					...
					If fields.Length <> CSV_COLUMN_COUNT Then
						...
						Throw New Exception( _
							...
							"Expected Fields : " & CSV_COLUMN_COUNT.ToString() & _
							Environment.NewLine & _
							"Actual Fields : " & fields.Length.ToString())
...
Private Const COL_SCENARIO As Integer = 5

Private Const COL_TIME As Integer = 6

Private Const COL_ENTITY As Integer = 7

Private Const COL_PARENT As Integer = 8

Private Const COL_CONS As Integer = 9

Private Const COL_ACCOUNT As Integer = 10

Private Const COL_FLOW As Integer = 11

Private Const COL_ORIGIN As Integer = 12

Private Const COL_IC As Integer = 13

Private Const COL_UD1 As Integer = 14

Private Const COL_UD2 As Integer = 15

Private Const COL_UD3 As Integer = 16

Private Const COL_UD4 As Integer = 17

Private Const COL_UD5 As Integer = 18

Private Const COL_UD6 As Integer = 19

Private Const COL_UD7 As Integer = 20

Private Const COL_UD8 As Integer = 21

Private Const COL_VIEW As Integer = 22
