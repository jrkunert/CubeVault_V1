		...
		Private Shared Sub ReadCsv( _
			...
			Using parser As New Microsoft.VisualBasic.FileIO.TextFieldParser(ctx.CsvFile)
				...
				While Not parser.EndOfData
					...
					'Exit While    ' Use Exit While to test a single record
				...
				Log(si, "Restore API call completed.")

				If objXFResult Is Nothing Then

					Log(si, "XFResult returned Nothing.")

				Else

					Log(si, "XFResult returned successfully.")
