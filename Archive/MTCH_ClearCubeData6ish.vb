...
Namespace OneStream.BusinessRule.Finance.MTCH_ClearCubeData
	...
	Public Class MainClass
		...
		Private Const BR_VERSION As String = "6.0"
...
#Region "Helper Methods"
		...
		Private Shared Function ResolveHierarchyMembers( _
			...
			Log(si, "")
			Log(si, "*** ResolveHierarchyMembers CALLED ***")
			Log(si, "Dimension = " & dimensionName)
			Log(si, "Expression = " & expression)
...
#Region "Export"
		...
		Private Shared Sub ExecuteExport( _
			...
			Try
				...
				Log(si, "")
				Log(si, "Export Filters")
				Log(si, LOG_SEPARATOR)

				For Each kvp In ctx.FilterParameters
...
'====================================================================
		...
		Private Shared Function ReadCSV( _
